    ...
    <div className="space-y-6">
          ...
          <Card key={index} className="border-0 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl font-bold text-gray-800 mb-3">{stat.value}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <Card title="Recent Transactions" className="border-0 shadow-sm">
        ...
        <div className="space-y-6">
          ...
          <Card title="Quick Actions" className="border-0 shadow-sm">
            <div className="space-y-3">
              <button className="w-full p-3 bg-primary text-white rounded-lg hover:bg-primary/90 transition-colors font-medium">
                Create Payment Link
              </button>
              <button className="w-full p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors font-medium">
                Send Invoice
              </button>
              <button className="w-full p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors font-medium">
                Bulk Payout
          ...
          {/* Performance */}
          <Card title="This Month" className="border-0 shadow-sm">
            <div className="space-y-4">
              <div>
              ...
              <div>
                <div className="flex justify-between text-sm mb-2">
                  <span className="text-gray-600">Volume Target</span>
                  <span className="font-medium">₦2.8M / ₦5M</span>
                </div>
